(() => {
  ...
  const F = {
    loopCreate: function () {
      ...
      for (let e = a.length - 1; e >= 0; e -= 1)
        n.prepend(x(a[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
    },
    loopFix: function () {
      const e = this;
      ...
      document.querySelector(".team__slider") &&
        new de(".team__slider", {
          ...
          breakpoints: {
            ...
            1500: { slidesPerView: 4, spaceBetween: 54 },
          },
          on: {},
        });
  });
        ...
        if ("click" === e.type) {
          ...
          if (t.closest("[data-goto]")) {
            ...
            ((e, t = !1, s = 500, i = 0) => {
              ...
              s.dataset.goto ? s.dataset.goto : "",
              !!s.hasAttribute("data-goto-header"),
              s.dataset.gotoSpeed ? s.dataset.gotoSpeed : "500"
            ),
              e.preventDefault();
          }
